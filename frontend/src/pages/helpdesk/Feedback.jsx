...
function Feedback(){
  const allCategory=[
    ...
    {"category":"Health & Hygience","img":"/Health.png","description":"Let us know how we can enhance health and hygiene standards to ensure a clean and healthy work environment"},
...
const IndividualCategory=({categoryName,img,description})=>{
  ...
  return (
    <button onClick={handleChooseCategory} className="flex flex-col h-44 w-48 justify-center items-center m-7 bg-[#EAF3FF] rounded-lg">
